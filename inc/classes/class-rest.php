<?php
/**
 * Rest class to handle all the REST API related functionalities.
 *
 * @package onedesign
 */
...
class Rest {
	...
	// Option names from your class-settings.php.
	/**
	...
	public function get_all_consumer_site_patterns(): WP_Error|WP_REST_Response {
		...
		if ( empty( $all_patterns ) ) {
			return new WP_Error( 'no_patterns_found', __( 'No patterns found across configured child sites.', 'onedesign' ), array( 'status' => 404 ) );
		}

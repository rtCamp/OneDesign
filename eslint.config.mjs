...
export default [
	...
	// Plugin-specific globals injected via wp_localize_script / wp_add_inline_script.
	{
		languageOptions: {
			globals: {
				patternSyncData: 'readonly',
				TemplateLibraryData: 'readonly',
				OneDesignSettings: 'readonly',
				OneDesignMultiSiteSettings: 'readonly',
			},
		},
	},
